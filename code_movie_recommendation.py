...
# 读取路径为"D:\tools\Programming\VSCODE\python_vscode\Files_RequiredforPractice\movie\movie\ratings.csv"的文件
# 设置参数分隔符号sep="::"
...
# 将结果赋值给变量ratings
#ratings=pd.read_csv(r"D:\tools\Programming\VSCODE\python_vscode\Files_RequiredforPractice\movie\movie\ratings.csv",
                    #sep="::",
                    #header=None,
...
# TODO 使用to_csv()函数，将处理好的ratings保存至"D:\tools\Programming\VSCODE\python_vscode\Files_RequiredforPractice\movie\movie\ratings01.csv"，传入参数index = False不将行索引信息写入第一列
#ratings.to_csv(r"D:\tools\Programming\VSCODE\python_vscode\Files_RequiredforPractice\movie\movie\ratings01.csv",index=False)

# 输出查看ratings
#print(ratings)

# 读取路径为"D:\tools\Programming\VSCODE\python_vscode\Files_RequiredforPractice\movie\movie\movies.csv"的文件
#movies = pd.read_csv(r"D:\tools\Programming\VSCODE\python_vscode\Files_RequiredforPractice\movie\movie\movies.csv",
                     #usecols = ["电影id","电影名"]
                     #)

# 将处理好的movies保存至"D:\tools\Programming\VSCODE\python_vscode\Files_RequiredforPractice\movie\movie\movies01.csv"
#movies.to_csv(r"D:\tools\Programming\VSCODE\python_vscode\Files_RequiredforPractice\movie\movie\movies01.csv",index = False)
